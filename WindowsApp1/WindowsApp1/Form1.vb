Public Class Form1
    ...
    Sub AddSubmitTicket()
        ...
        failButton.Show()
        submitDesc.Show()
        submitDesc.Text = "Submit the ticket you with to add time to:"
    ...
    Sub RefundSubmitTicket()
        ...
        submitDesc.Text = "Submit the ticket you with to refund:"
        'ticket.Show()
        'Label2.Show()
...
Are you parking or leaving?"
    ...
    Private Sub failButton_Click(sender As Object, e As EventArgs) Handles failButton.Click
        ...
        ElseIf currentState = 2 Or 3 Then
            MsgBox("Failed to read receipt. Try submitting receipt again.")
        End If
